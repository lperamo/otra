...
class Routes
{
  ...
  $_ = [
    ...
    'refreshSQLLogs' => [
      'chunks' => ['/dbg/refreshSQLLogs', 'src', 'otra', 'profiler', 'refreshSQLLogsAction'],
      'core' => true
    ],

    'clearSQLLogs' => [
      'chunks' => ['/dbg/clearSQLLogs', 'src', 'otra', 'profiler', 'clearSQLLogsAction'],
      'core' => true
    ],
    'profiler' => [
      'chunks' => ['/dbg', 'src', 'otra', 'profiler', 'indexAction'],
      'core' => true
    ]
  ];
