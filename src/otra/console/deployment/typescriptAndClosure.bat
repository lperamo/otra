...
if "%6" == "NO" (
  ...
  (%APPDATA%\npm\tsc.cmd %1/%3.ts --pretty --typeRoots %5/node_modules/@types --sourcemap %1/%2 --out %4/js/%3.js || echo 'Errors to fix but these are not blocking.') && java -jar %5/lib/otra/console/compiler.jar --compilation_level %6 --rewrite_polyfills=false --js %1/%3.js --js_output_file %4/js/%3.js
)
