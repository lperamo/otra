...
{ADD_BOLD, CLI_BASE, CLI_ERROR, CLI_INFO_HIGHLIGHT, CLI_WARNING, END_COLOR, REMOVE_BOLD_INTENSITY};
...
foreach($iterator as $entry)
{
  ...
  else
  {
    ...
    {
      if (!is_string($route))
        echo CLI_WARNING, LABEL_YOUR_ROUTE, CLI_INFO_HIGHLIGHT, $route, CLI_WARNING, ' is not a string!', END_COLOR, PHP_EOL;
