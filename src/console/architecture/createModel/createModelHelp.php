...
return [
  ...
  [
    ...
    'method' => '1 => Creates from nothing' . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . '2 => One model from '. CLI_LIGHT_CYAN . 'schema.yml' .
      CLI_CYAN .
      PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . '3 => All models from ' . CLI_LIGHT_CYAN .'schema.yml' .
      CLI_CYAN . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . 'Useless with the ' . CLI_LIGHT_CYAN . 'interactive' . CLI_CYAN . ' mode.',
    'interactive' => 'If set to false, no question will be asked but the status messages are shown.' . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . 'Defaults to true.',
    'model location' => 'Location of the model to create :' . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . '0 => in the ' . CLI_LIGHT_CYAN . 'bundle (default)' . CLI_CYAN
      . ' folder' . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . '1 => in the ' . CLI_LIGHT_CYAN . 'module' . CLI_CYAN . ' folder.' . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . 'Only useful (and required) for the ' . CLI_LIGHT_CYAN . 'interactive' .
      CLI_CYAN . ' mode.',
    'module name' => 'Name of the module in which the model have to be created.' . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . 'Only useful (and required) for the ' . CLI_LIGHT_CYAN
      . 'interactive' . CLI_CYAN . ' mode.',
    'model name' => 'Name of the model to create.' . PHP_EOL .
      STRING_PAD_FOR_OPTION_FORMATTING . 'Only useful (and required) for the ' . CLI_LIGHT_CYAN . 'interactive' .
      CLI_CYAN . ' mode.' . PHP_EOL .
