...
use function lib\otra\console\returnLegiblePath;
use const lib\otra\console\GOOGLE_CLOSURE_COMPILER_VERBOSITY;
  ...
  if ($typescriptConfig !== null)
  {
    ...
    if ($jsFileExists === true)
    {
      ...
      if ($launch === true)
      {
        ...
        list($return, $output) = cli('java -jar ' . BASE_PATH . 'src/otra/console/compiler.jar -W '
