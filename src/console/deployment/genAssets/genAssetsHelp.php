...
return [
  ...
  [
    'mask' => '1 => templates' . PHP_EOL .
      ...
      str_repeat(' ', TasksManager::STRING_PAD_FOR_OPTION_FORMATTING) . '8 => JSON manifest' . PHP_EOL .
      str_repeat(' ', TasksManager::STRING_PAD_FOR_OPTION_FORMATTING) . '15 => all (default)',
