...
EOF;
    ...
    {
        $input = <<<EOF
foo: !!php/object:O:30:"lib\sf2_yaml\Tests\B":1:{s:1:"b";s:3:"foo";}
bar: 1
EOF;
...
EOF;
    ...
    /**
     * @expectedException \lib\sf2_yaml\Exception\ParseException
     */
    ...
    public function testNonUtf8Exception()
    {
        ...
        foreach ($yamls as $yaml) {
            try {
                ...
                $this->assertInstanceOf('lib\sf2_yaml\Exception\ParseException', $e, 'charsets other than UTF-8 are rejected.');
            }
        }
    }
...
EOF
     ...
     *
     * @covers \lib\sf2_yaml\Parser::parse
     */
...
EOD;
    ...
    /**
     * @covers \lib\sf2_yaml\Inline::parseMapping
     */
