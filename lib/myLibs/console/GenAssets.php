...
function js(string $shaName, array $chunks, string $bundlePath, array $resources)
{
  ...
  exec('java -Xmx32m -Djava.util.logging.config.file=logging.properties -jar ' . CORE_PATH . 'console/compiler.jar --logging_level FINEST -W QUIET --js ' .
