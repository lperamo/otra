...
typeset -a OTRA_COMMANDS_DESCRIPTIONS=(
  ...
  "${CAT_ARCHITECTURE} createGlobalConstants       : ${CYA}Creates OTRA global constants. [38;2;214;191;85mOnly use it if you have changed the project folder or OTRA vendor folder location.[38;2;41;153;153m${ECO}"
  "${CAT_ARCHITECTURE} createHelloWorld            : ${CYA}Creates a hello world starter application.${ECO}"
  "${CAT_ARCHITECTURE} createModel                 : ${CYA}Creates a model. [38;2;108;218;218mhow[38;2;41;153;153m parameter is ignored in interactive mode${ECO}"
  ...
  "${CAT_DEPLOYMENT} deploy                      : ${CYA}Deploy the site. [38;2;214;191;85m[Currently only works for unix systems !][0m${ECO}"
