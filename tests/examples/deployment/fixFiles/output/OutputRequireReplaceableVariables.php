...
namespace otra\cache\php;use \Exception; use \Error; use \Throwable; use \stdClass; use \RecursiveDirectoryIterator; use \RecursiveIteratorIterator; use Phar; use \PharData; use \DateTime; use \Redis;const VERSION='2024.0.0',RESOURCE_FILE_MIN_SIZE=21000,CACHE_TIME=300;abstract class AllConfig
{
  ...
  ], $sassLoadPaths = [BUNDLES_PATH . 'HelloWorld/resources/']; }class TestRequireAllConfig
{
