...
class CreateModelHelpTest extends TestCase
{
  ...
  public function test() : void
  {
    $this->expectOutputString(
      ...
      '   + ' . str_pad('bundle name', TasksManager::PAD_LENGTH_FOR_TASK_OPTION_FORMATTING) .
      CLI_GRAY . ': ' . CLI_INFO_HIGHLIGHT . '(' . TasksManager::OPTIONAL_PARAMETER .
      ') ' . CLI_INFO . 'The bundle in which the model have to be created' . PHP_EOL .
      CLI_INFO_HIGHLIGHT .
      '   + ' . str_pad('method', TasksManager::PAD_LENGTH_FOR_TASK_OPTION_FORMATTING) .
      CLI_GRAY . ': ' . CLI_INFO_HIGHLIGHT . '(' . TasksManager::OPTIONAL_PARAMETER .
      ...
      CLI_INFO_HIGHLIGHT .
      '   + ' . str_pad('model location', TasksManager::PAD_LENGTH_FOR_TASK_OPTION_FORMATTING) .
      CLI_GRAY . ': ' . CLI_INFO_HIGHLIGHT . '(' . TasksManager::OPTIONAL_PARAMETER .
      ...
      CLI_INFO_HIGHLIGHT .
      '   + ' . str_pad('module name', TasksManager::PAD_LENGTH_FOR_TASK_OPTION_FORMATTING) .
      CLI_GRAY . ': ' . CLI_INFO_HIGHLIGHT . '(' . TasksManager::OPTIONAL_PARAMETER .
      ') ' . CLI_INFO .
      ...
      . self::OTRA_INTERACTIVE_MODE_NAME . CLI_INFO . self::OTRA_INTERACTIVE_MODE_NAME_SECOND . PHP_EOL .
      CLI_INFO_HIGHLIGHT .
      '   + ' . str_pad('model name', TasksManager::PAD_LENGTH_FOR_TASK_OPTION_FORMATTING) .
      CLI_GRAY . ': ' . CLI_INFO_HIGHLIGHT . '(' . TasksManager::OPTIONAL_PARAMETER .
      ') ' . CLI_INFO .
      ...
      CLI_INFO_HIGHLIGHT .
      '   + ' . str_pad('model properties', TasksManager::PAD_LENGTH_FOR_TASK_OPTION_FORMATTING) .
      CLI_GRAY . ': ' . CLI_INFO_HIGHLIGHT . '(' . TasksManager::OPTIONAL_PARAMETER .
      ') ' . CLI_INFO .
      ...
      CLI_INFO_HIGHLIGHT .
      '   + ' . str_pad('model SQL types', TasksManager::PAD_LENGTH_FOR_TASK_OPTION_FORMATTING) .
      CLI_GRAY . ': ' . CLI_INFO_HIGHLIGHT . '(' . TasksManager::OPTIONAL_PARAMETER .
      ') ' . CLI_INFO .
